...
fpow <- function( k, n, model, target_parameter ){
...
# Rfiles <- Rfiles[ !Rfiles %in% c("fpow.R","app.R","Input - Single Process with a Single Indicator.R","Input - Two Processes with Two Indicator Each.R") ]
# for( Rfile in Rfiles ){
	# source( Rfile )
# }
